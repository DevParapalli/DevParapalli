...
BG     = (13,  15,  22)    # near-black deep navy
BG2    = (18,  22,  34)    # slightly lighter
SLATE  = (240, 240, 245)   # near-white for name
MID    = (150, 155, 175)   # muted grey for subtitle
ACCENT = (99,  130, 255)   # bright indigo
RULE   = (45,  50,  70)    # subtle dark divider
DOT    = (40,  48,  72)    # dark dot grid
...
ghost_c = tuple(int(BG[i] + (ACCENT[i] - BG[i]) * 0.12) for i in range(3))
...
for i, dx in enumerate([0, -14, -28]):
    dot_c = ACCENT if i == 0 else (60, 70, 110)
    x0 = right_edge + dx - 2
    y0 = url_y + url_h + 20
