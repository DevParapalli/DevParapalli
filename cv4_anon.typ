...
#let github = "github.com/USERID"
#let linkedin = "linkedin.com/in/USERID"
...
#edu(
  institution: "Tier 3 College, City",
...
- CGPA: 8.20\/10.0 | Relevant Coursework: AI/ML, Deep Learning, Data Structures and Algorithms, Compiler Design, Web Development, Python Programming, Java Fundamentals, Data Science, Abstract Mathematics, Linear Algebra, Calculus 
...
#project(
  ...
  name: "AI-powered Knowledge Organizer",
  url: "aiko.example.com"
)
...
#project(
  ...
  name: "University Result Scraping",
  url: "https://github.com/USERID/result-scraping-project",
)
- Created a customizable scraping application that scrapes the results site, including SGPA and Pass/Fail.
- Implemented state management and state sync between the browser context and application context.
- Added functionality to have College-wise, University-wise rank lists as well as checkpoint-based error recovery.
